...
export default function Footer() {
  return (
    <Reveal>
    <footer className="bg-black/45 backdrop-blur-md text-white py-12 relative">
  <div className="container mx-auto px-6 grid md:grid-cols-4 gap-10">
    ...
    <div>
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex flex-col leading-tight">
          ...
          <span className="text-sm text-white/70">Premium Pickles</span>
        </div>
      </div>
    ...
    <div>
      ...
      <p className="text-white/70 mb-2">123 Jhatka Street, Lahore, Pakistan</p>
