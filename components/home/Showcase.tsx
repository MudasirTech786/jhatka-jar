          ...
          {products.map((item) => (
            ...
            >
              ...
              <div className="relative w-full aspect-[1/1] sm:aspect-[3/4] overflow-hidden rounded-xl shadow-lg">
                ...
                {item.badge && (
                  <span className="absolute top-2 left-2 text-xs px-3 py-1 rounded-full bg-red-600 text-white z-10">
                    {item.badge}
                  </span>
                )}

                <span className="absolute top-2 right-2 text-xs px-3 py-1 rounded-full bg-green-600 text-white z-10">
                  Free Sample
                </span>
              ...
              <span className="mt-1 text-green-700 font-bold text-sm sm:text-base">
                FREE SAMPLE
              </span>
